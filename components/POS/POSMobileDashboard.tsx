    ...
    <div className="h-full overflow-y-auto bg-white p-4 md:hidden">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-4 bg-primary-50 rounded-xl border border-primary-200">
          <p className="text-xs font-semibold text-primary-600 dark:text-primary-400 mb-1">Active Orders</p>
          <p className="text-2xl font-bold text-primary-700">{quickStats.activeOrders}</p>
        </div>
        <div className="p-4 bg-success-50 dark:bg-success-900/20 rounded-xl border border-success-200 dark:border-success-700">
        ...
        <div className="p-4 bg-accent-50 dark:bg-accent-900/20 rounded-xl border border-accent-200 dark:border-accent-700">
        ...
        <div className="p-4 bg-warning-50 dark:bg-warning-900/20 rounded-xl border border-warning-200 dark:border-warning-700">
